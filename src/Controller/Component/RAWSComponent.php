...
class RAWSComponent extends Component {
    ...
    public function initialize(array $config)
    {
        ...
        $this->AWS_Access_key = $this->Const->AWS_Access_key;
        $this->AWS_Secret_key = $this->Const->AWS_Secret_key;
    }
    ...
    public function RekognitionFactry(){
        $tmp = RekognitionClient::factory([
            'credentials' => [
                'key'   => RAWSComponent::AWS_Access_key,
                'secret'=> RAWSComponent::AWS_Secret_key
            ],
