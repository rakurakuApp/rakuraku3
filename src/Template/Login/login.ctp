                ...
                <div class="login-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lg_username" name="id" placeholder="ID"
                               value="<?php if(!empty($this->request->getData('id'))){echo $this->request->getData('id');}?>">
                    </div>
                    <div class="form-group">
                        <label for="lg_password" class="sr-only">Password</label>
                        <input type="password" class="form-control" id="lg_password" name="password" placeholder="Password"
                               value="<?php if(!empty($this->request->getData('password'))){echo $this->request->getData('password');}?>">
                    </div>
                    <div class="form-group login-group-checkbox down">
                        <input type="checkbox" id="lg_remember" name="teacher"<?php if(!empty($this->request->getData('teacher'))){echo 'checked';} ?>>
