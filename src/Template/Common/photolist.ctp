    ...
    <div class="box">
        ...
        <form class="form-inline" method="post">
            <div class="row">
                ...
                <div class="search_contents display" id="search_contents">
                    <!-- 子供の名前 -->
                    <div class="col-md-12">
                    ...
                    <!-- 学校行事 -->
                    <div class="col-md-12">
                        <button type="button" id="eventSelectBtn" class="btn btn-info" data-toggle="modal"
                                                    ...
                                                    <li>
                                                        <ul class="col-xs-12" id="drop">
                                                            <div class="balloon1-left" id="dummy">
                                                                ...
                                                                <li>
                                                                    <a id="<?= $detail[1]['id']; ?>"><?= $detail[1]['detail'] ?></a>
                                                                </li>
                                                                <li>
                                                                    <a id="<?= $detail[2]['id']; ?>"><?= $detail[2]['detail'] ?></a>
                                                                </li>
                                                                <li>
                                                                    <a id="<?= $detail[3]['id']; ?>"><?= $detail[3]['detail'] ?></a>
                                                                </li>
